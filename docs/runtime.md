...
Version 1.2.0-beta.1 preserves the deterministic browser-local Runtime foundation across the Agent and Prompt Playgrounds. It supports mock, dryRun, and disabled liveReserved modes through typed domain services outside React.
