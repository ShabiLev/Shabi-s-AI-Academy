...
- Occurred: 2026-07-14T13:33:24.382Z to 2026-07-14T13:49:19.980Z
- Branch: feature/1.4.0-agent-operating-system
- Commit tested: 78c9485b0adf355fc3357a5ee1ef12a1dee6882d
- Profile: full
...
- Commands passed: npm run docs:check, npm run aos:check, npm run test:evidence, npm run test:aos, npm run lint, npm run test:run, npm run test:coverage, npm run catalog:check, npm run test:journeys, npm run test:click-audit, npm run test:route-crawl, npm run test:forms, npm run test:overlays, npm run test:responsive:interactions, npm run test:keyboard, npm run test:copy, npm run test:errors, npm run test:ux, npm run test:a11y, npm run quality:collect, npm run quality:system-report, git diff --check
...
- Heavy local artifacts: `quality/execution/runs/2026-07-14_16-33-24_feature-1-4-0-agent-operating-system/` (ignored), plus copied Playwright, coverage, and quality-generated reports when available.
