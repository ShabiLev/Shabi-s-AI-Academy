# Codex Prompt — Release preparation

You are working in Shabi's AI Academy. Complete the defined release without changing its accepted scope.
...
2. Read `AGENTS.md`, `.codex/README.md`, release spec, QA handbook, versioning and Git standards. Resolve conflicts through the documented hierarchy; do not invent material requirements.
