    ...
    assert: {
      assertions: {
        "categories:performance": [
          "error",
          { minScore: thresholds.desktop.performance },
        ],
        "categories:accessibility": [
          "error",
          { minScore: thresholds.desktop.accessibility },
        ],
        "categories:best-practices": [
          "error",
          { minScore: thresholds.desktop.bestPractices },
        ],
        "categories:seo": ["warn", { minScore: thresholds.desktop.seo }],
        "largest-contentful-paint": [
          "warn",
          { maxNumericValue: thresholds.metrics.largestContentfulPaintMs },
        ],
        "cumulative-layout-shift": [
          "warn",
          { maxNumericValue: thresholds.metrics.cumulativeLayoutShift },
        ],
        "total-blocking-time": [
          "warn",
          { maxNumericValue: thresholds.metrics.totalBlockingTimeMs },
        ],
      },
    },
    upload: {
