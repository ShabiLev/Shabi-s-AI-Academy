...
export type GateStatus = 'passed' | 'failed' | 'warning' | 'notRun' | 'notAvailable'
...
export type IssueType = 'bug' | 'accessibility' | 'performance' | 'visual' | 'automation' | 'technicalDebt'
...
export type ReleaseStatus = 'ready' | 'readyWithWarnings' | 'blocked' | 'notEvaluated'
