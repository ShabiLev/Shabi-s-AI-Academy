...
MockProvider is the only executable provider in 1.2.0-beta.1. It performs no network call, random generation, delay, external file access, tool execution, or prompt execution.
