...
export const roadmapItems: readonly RoadmapItem[] = [
  ...
  { version: "1.2.0-beta.1", status: "completed", title: { he: "רדאר AI וחיזוק חוויית המשתמש", en: "AI Radar and UX Hardening" }, summary: { he: "רדאר דו-לשוני מבוסס מקורות, תפריט פרופיל נגיש וייצוב תצוגה רספונסיבית.", en: "A source-based bilingual Radar, accessible profile menu, and responsive UX stabilization." } },
  { version: "future", status: "planned", title: { he: "שיתוף פעולה ותזמור מקומי", en: "Local collaboration and orchestration" }, summary: { he: "גילוי תזמור רב-סוכנים, תבניות תהליך ושיתוף מבוקר לפני חיבור ספקים חיים.", en: "Discover multi-agent orchestration, workflow templates, and controlled sharing before live providers." } },
