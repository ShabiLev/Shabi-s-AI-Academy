  ...
  return (
    <div className="page how-to-page" id="top">
      ...
      <section className="settings-card">
        ...
        <p>
          {ui === "he"
            ? "בגרסה 1.5.0-beta.1 פלט Mock הוא סימולציה ו-Dry Run הוא תצוגה מקדימה. הרצה חיה מושבתת, מידע אינו נשלח החוצה וכלים חיצוניים אינם מופעלים."
            : "In Version 1.5.0-beta.1, Mock output is simulated and Dry Run is a preview. Live Run is disabled, no data is sent externally, and no real tool is executed."}
        </p>
      </section>
    </div>
  );
