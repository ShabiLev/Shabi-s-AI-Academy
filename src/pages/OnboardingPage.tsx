...
import { interestDisplayLabel, interests, recommendStartingPath, useOnboarding, type ExperienceLevel, type Interest, type MainGoal } from "../onboarding";
