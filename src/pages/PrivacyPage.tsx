...
export function PrivacyPage() {
  ...
  return <main className="legal-page"><article>
    ...
    <p>{he ? "גיבוי מקומי יכול לכלול את חמשת תחומי 1.8 לאחר תצוגה מקדימה. WALK ME אינו נכלל. ניתוח השימוש כבוי עד להסכמה מפורשת ומוגבל לסוג אירוע, זמן וקטגוריה גסה; הוא דוחה מטרות, תוכן, מזהים, הערות, נתונים אישיים וסודות." : "A local backup can include the five Version 1.8 domains after preview. WALK ME is excluded. Analytics stays off until explicit consent and is limited to event type, time, and coarse category; it rejects goals, content, identifiers, notes, personal data, and secrets."}</p>
