...
export const IMPORTED_REPORT_STORAGE_KEY = 'shabi-ai-academy.qa-report-import.v1'
...
export const sampleQualityReport: QualityReport = {
  ...
  tests: {
    ...
    playwright: { total: 42, failed: 0, skipped: 0, browserProjects: 5, durationMs: 138000 },
  },
  coverage: {
    statements: 95.5,
    branches: 85.46,
  ...
  visual: {
    ...
    comparedCount: 20,
    mismatches: 0,
    baselineEnvironment: 'visual-chromium (Windows, pending Linux CI regeneration)',
    ...
    routes: [
      {
        ...
        bestPractices: 96,
        seo: 90,
        metrics: { largestContentfulPaintMs: 1200, cumulativeLayoutShift: 0.01, totalBlockingTimeMs: 60 },
      },
      {
        route: '/',
        device: 'mobile',
        ...
        bestPractices: 96,
        seo: 90,
        metrics: { largestContentfulPaintMs: 2200, cumulativeLayoutShift: 0.02, totalBlockingTimeMs: 140 },
      },
    ],
    thresholds: {
      desktop: { performance: 85, accessibility: 90, bestPractices: 90, seo: 80 },
      mobile: { performance: 75, accessibility: 90, bestPractices: 90, seo: 80 },
    },
    status: 'passed',
  },
  knownIssues: {
...
export function computeReportStaleness(
  ...
  return {
    ...
    commitMismatch: Boolean(currentCommitSha && report.commitSha && report.commitSha !== currentCommitSha),
