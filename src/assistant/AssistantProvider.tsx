...
export function AssistantProvider({ children }: { children: ReactNode }) {
  ...
  const location = useLocation(); const navigate = useNavigate(); const prompts = usePromptLibrary(); const agents = useAgentLibrary(); const projects = useProjects(); const runtime = useRuntime(); const missions = useMissions();
