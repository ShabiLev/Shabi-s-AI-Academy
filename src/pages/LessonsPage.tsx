...
const statusKeys = {
  ...
  "coming-soon": "course.status.comingSoon",
} as const;
  ...
  return (
    <div className="page lessons-page">
      <header className="page-heading">
        ...
        <Link to="/how-to#lessons">{language === "he" ? "עזרה" : "Help"}</Link>
      </header>
        ...
        <section key={module.id} aria-labelledby={`module-${module.id}`}>
          <header className="page-heading module-heading">
            <span className="eyebrow">
              {t("course.module")} {module.order}
            </span>
            <h2 id={`module-${module.id}`}>{module.title[language]}</h2>
