...
Live execution is disabled in 1.0.0-beta.1. Mock and Dry Run remain available. The browser shows no credential field, stores no API keys, and makes no direct provider call.
