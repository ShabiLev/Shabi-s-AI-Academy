...
export const roadmapItems: readonly RoadmapItem[] = [
  ...
  { version: "1.0.0-beta.1", status: "inProgress", title: { he: "בטא מלאה", en: "Complete beta" }, summary: { he: "תוכן מלא, קטלוגים, Playgrounds, פרויקטים ומאגר ידע.", en: "Full content, catalogs, Playgrounds, Projects, and Knowledge Base." } },
