...
Define the 1.0.0-beta.1 execution boundary without implying live AI connectivity.

## Current state

Version 1.0.0-beta.1 uses the typed state machine, deterministic MockProvider, Dry Run, approval/retry/cancellation, planned-tool registry, and bounded local history across both Playgrounds. Live providers remain unavailable.
