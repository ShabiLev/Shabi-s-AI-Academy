...
const patterns: Array<[AssistantIntent, RegExp]> = [
  ["defineConcept", /what is (?:an? )?(agent|mock run|dry run|prompt|workflow|llm)|מה (?:זה|הוא|היא) (?:סוכן|פרומפט|הרצת דמה|תהליך)/u],
  ["explainScreen", /where am i|what does this page do|why would i use it|what should i do next|איפה אני|מה עושים כאן|מה כדאי לעשות/u],
