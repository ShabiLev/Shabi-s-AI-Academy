...
export const pageRegistry: PageMetadata[] = [
  ...
  seed({ id: "missions", route: "/missions", area: "workspace", title: text("משימות", "Missions"), summary: text("נהלו מטרות, צוותים, מסירות וראיות.", "Manage goals, teams, handoffs, and evidence."), primaryAction: { label: text("משימה חדשה", "New mission"), to: "/missions/new" }, glossaryTerms: ["agent", "workflow"] }),
  seed({ id: "mission-new", route: "/missions/new", area: "build", title: text("בניית משימה", "Mission Builder"), summary: text("בדקו פירוש, תכנית וצוות לפני התחלה.", "Review interpretation, plan, and team before starting."), parent: "missions" }),
  seed({ id: "mission-workspace", route: "/missions/:missionId", area: "workspace", title: text("סביבת משימה", "Mission Workspace"), summary: text("עקבו אחר השלב הפעיל, המסירות והראיות.", "Follow the active phase, handoffs, and evidence."), parent: "missions" }),
  seed({ id: "mission-team", route: "/missions/:missionId/team", area: "workspace", title: text("צוות המשימה", "Mission Team"), summary: text("בדקו תפקידים, הרשאות וייחוס עבור המשימה.", "Review roles, permissions, and attribution for the mission."), parent: "mission-workspace" }),
  seed({ id: "mission-plan-scoped", route: "/missions/:missionId/plan", area: "workspace", title: text("תכנית המשימה", "Mission Plan"), summary: text("בדקו שלבים, בעלות ושערי איכות.", "Review phases, ownership, and quality gates."), parent: "mission-workspace" }),
  seed({ id: "mission-evidence-scoped", route: "/missions/:missionId/evidence", area: "workspace", title: text("ראיות המשימה", "Mission Evidence"), summary: text("בדקו תוצאות מוסברות וראיות למידה.", "Review explained results and learning evidence."), parent: "mission-workspace" }),
  seed({ id: "team", route: "/team", area: "build", title: text("צוותי סוכנים", "Agent Teams"), summary: text("בדקו תפקידים, הרשאות, תבניות וייחוס.", "Review roles, permissions, presets, and attribution.") }),
  seed({ id: "mission-plan", route: "/plan", area: "workspace", title: text("תכנית משימה", "Mission Plan"), summary: text("הציגו את השלבים והשערים של המשימה הפעילה.", "Inspect phases and gates for the active mission.") }),
  seed({ id: "mission-evidence", route: "/evidence", area: "workspace", title: text("ראיות משימה", "Mission Evidence"), summary: text("בדקו תוצאות PASS/FAIL מוסברות.", "Review explained PASS/FAIL results.") }),
