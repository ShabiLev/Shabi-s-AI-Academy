...
select c.relname, c.relrowsecurity from pg_class c join pg_namespace n on n.oid=c.relnamespace where n.nspname='public' and c.relname in ('profiles','user_preferences','user_progress','user_prompts','user_agents','projects','project_entities','knowledge_documents','workflows','runtime_runs','favorites','recent_items','notifications','onboarding_profiles','sync_metadata','audit_events','account_roles') order by c.relname;
