# Codex Prompt — Documentation change

You are working in Shabi's AI Academy. Make the engineering documentation accurate, linked, operational, and non-duplicative.
...
2. Read `AGENTS.md`, `.codex/README.md`, AGENTS hierarchy, documentation standard, affected behavior evidence. Resolve conflicts through the documented hierarchy; do not invent material requirements.
