...
const names = [
  ...
  ["evaluation-lab", "Agent Evaluation Lab", "מעבדת הערכת סוכנים", "/evaluations"],
  ["rubric-builder", "Transparent Rubrics", "מחוונים שקופים", "/evaluations/new"],
  ["evaluation-trace", "Trace and Evidence", "עקבות וראיות", "/evaluations"],
  ["regression-suites", "Regression Suites", "חבילות רגרסיה", "/evaluation-suites"],
  ["connected-preview", "Connected Action Preview", "תצוגה מקדימה לפעולה מחוברת", "/evaluations"],
  ["codex-export", "Validated Codex Export", "ייצוא Codex מאומת", "/evaluations"],
