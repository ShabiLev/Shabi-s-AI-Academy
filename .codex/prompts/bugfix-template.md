...
You are working in Shabi's AI Academy. Reproduce, diagnose, and fix the verified defect with regression coverage.
...
2. Read `AGENTS.md`, `.codex/README.md`, bug report, responsible domain docs, active release rules. Resolve conflicts through the documented hierarchy; do not invent material requirements.
