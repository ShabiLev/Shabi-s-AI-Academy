# Codex Prompt — Behavior-preserving refactor

You are working in Shabi's AI Academy. Improve the specified structure while proving behavior remains unchanged.
...
2. Read `AGENTS.md`, `.codex/README.md`, refactor plan, architecture boundaries, characterization tests. Resolve conflicts through the documented hierarchy; do not invent material requirements.
