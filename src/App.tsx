...
export function App() {
  return <BrowserRouter><AuthProvider><CourseProgressProvider><PromptLibraryProvider><Routes>
    ...
    <Route element={<ProtectedRoute />}><Route element={<AppLayout />}><Route index element={<DashboardPage />} /><Route path="lessons" element={<LessonsPage />} /><Route path="lessons/:lessonSlug" element={<LessonPage />} /><Route path="prompt-library" element={<PromptLibraryPage />} /><Route path="prompts" element={<PromptLibraryPage />} /><Route path="prompts/new" element={<PromptBuilderPage />} /><Route path="prompts/:promptId" element={<PromptDetailsPage />} /><Route path="prompts/:promptId/edit" element={<PromptBuilderPage />} /><Route path="agents" element={<AgentsPage />} /><Route path="projects" element={<ProjectsPage />} /><Route path="radar" element={<RadarPage />} /><Route path="settings" element={<SettingsPage />} /><Route path="qa" element={<QACenterPage />} /></Route></Route>
