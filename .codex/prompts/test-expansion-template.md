# Codex Prompt — Test expansion

You are working in Shabi's AI Academy. Add risk-based automated coverage without weakening established assertions.
...
2. Read `AGENTS.md`, `.codex/README.md`, QA handbook, test spec, existing helpers/configuration. Resolve conflicts through the documented hierarchy; do not invent material requirements.
