...
Version 1.1.0-beta.1 ships the deterministic browser-local Runtime foundation across the Agent and Prompt Playgrounds. It supports mock, dryRun, and disabled liveReserved modes through typed domain services outside React.
