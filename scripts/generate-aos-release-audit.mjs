...
const findings = [
  ...
  entry("AOS-FULL-016", "All full browser, visual, performance, release, and evidence gates pass at current HEAD.", "Pending final full execution after implementation changes.", "partial", ["quality/runtime/execution/latest/"], "A current full evidence run is still required.", "critical", "Run the complete ordered suite and retain honest failures."),
];
