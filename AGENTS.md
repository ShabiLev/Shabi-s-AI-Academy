...
- Current release: 1.1.0-beta.1. Active development targets 1.2.0-beta.1 under `.codex/release-1.2-ai-radar-ux/`; prior release specifications remain historical.
