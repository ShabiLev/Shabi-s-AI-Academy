...
You are working in Shabi's AI Academy. Implement the accepted feature specification end-to-end.
...
2. Read `AGENTS.md`, `.codex/README.md`, feature spec, relevant architecture/standards, active Sprint. Resolve conflicts through the documented hierarchy; do not invent material requirements.
